...
from . import limx_pointfoot_jump_cfg

# Jump task uses the same PPO configuration as walking
limx_pf_jump_runner_cfg = PF_TRON1AFlatPPORunnerCfg()

gym.register(
    id="Isaac-Limx-PF-Jump-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": limx_pointfoot_jump_cfg.PFJumpEnvCfg,
        "rsl_rl_cfg_entry_point": limx_pf_jump_runner_cfg,
    },
)

gym.register(
    id="Isaac-Limx-PF-Jump-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": limx_pointfoot_jump_cfg.PFJumpEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": limx_pf_jump_runner_cfg,
    },
)